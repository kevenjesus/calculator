const culturedAndSpecies = (overflow, qtdAnalysis, especiesMunicipio, densidadePop2010) => {
        ...
        const calc4 = 2.145 * Math.log(especiesMunicipio);
        ...
        const custoTotalEspeciesBRL = custoEspeciesporHaBRL * qtdAnalysis * overflow;
