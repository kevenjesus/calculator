...
const dredgingAndRiverSediments = (hectare, pitDepth, DistanciaGarimpoCentroUrbanoFrete, gold, tipoGarimpo, AnosGarimpoPoco, MesesGarimpoBalsa) => {
     

    let dredgingAndRiverSediments;
        if(tipoGarimpo === FERRY) {//input ouro
            ...
            //const ProdOuroTotalBalsaDragagem = PotenciaMediaMotor * MesesGarimpoBalsa * ProdOuroKgporMes;
            const ProducaoSedimentoViraPlumaTon = ProducaoSedimentoViraPlumaTonporMes * gold * MesesGarimpoBalsa;
            const EquivalenciaHaImpactados = ProducaoSedimentoViraPlumaTon / ErosaoEquivalenteTonporHaporAno;
            const ValorDanoDragagemBalsa = EquivalenciaHaImpactados * ControleErosaoR$
            return ValorDanoDragagemBalsa
        

        }else if (tipoGarimpo === PIT) { //input ouro
        ...
        }else if (tipoGarimpo === PIT){ //anos de garimpo no poço
            ...
            const QtdeGramasOuroTotalPoço = QtdeGramasOuroPorAnoPoço * AnosGarimpoPoco;
